<p align="center">
<img src="https://raw.githubusercontent.com/lbviviolet-wallis-marchmail-4/moesora/master/templates/assets/dist/logo.svg" alt="moesora" width="160">
</p>
...
<p align="center">
<a href="https://github.com/lbviviolet-wallis-marchmail-4/moesora/releases"><img alt="releases" src="https://img.shields.io/github/release/lbviviolet-wallis-marchmail-4/moesora.svg?style=flat-square"/></a>
...
<a href="https://github.com/lbviviolet-wallis-marchmail-4/moesora/blob/master/LICENSE"><img alt="license" src="https://img.shields.io/github/license/lbviviolet-wallis-marchmail-4/moesora?style=flat-square"/></a>
<a href="https://github.com/lbviviolet-wallis-marchmail-4/moesora/releases"><img alt="downloads" src="https://img.shields.io/github/downloads/lbviviolet-wallis-marchmail-4/moesora/total.svg?style=flat-square"/></a>
<a href="https://github.com/lbviviolet-wallis-marchmail-4/moesora/commits"><img alt="commits" src="https://img.shields.io/github/last-commit/lbviviolet-wallis-marchmail-4/moesora.svg?style=flat-square"/></a>
</p>
...
如有问题或建议，欢迎提交 [Issue](https://github.com/lbviviolet-wallis-marchmail-4/moesora/issues)；如果愿意参与改进，也欢迎提交 PR。
...
1. 进入主题 [Release](https://github.com/lbviviolet-wallis-marchmail-4/moesora/releases) 界面，下载主题压缩包 `moesora.zip`；
...
- Node.js 18+
- 主题目录下执行 `npm install` 安装依赖

**npm 命令**

- `npm run dev` —— 监听源码变化并持续构建（`vite build --watch`），便于调试；
- `npm run build` —— 编译 CoffeeScript + 打包 CSS，输出到 `templates/assets/dist/`；
- `npm run zip` —— 将运行时文件打包为 `dist/moesora.zip`（无需重新编译时使用）；
- `npm run package` —— 等价于 `npm run build && npm run zip`。
...
如果 Moesora 有帮助，欢迎请作者喝一杯奶茶 (｡･ω･｡)ﾉ♡ —— 每一份支持都是项目持续维护的动力。
...
> 也欢迎通过 Star ⭐ 与 [提交 Issue / PR](https://github.com/lbviviolet-wallis-marchmail-4/moesora/issues) 来支持本项目。
